...
class HnsSyncForegroundService : Service() {
    ...
    companion object {
        const val ACTION_SYNC_SNAPSHOT = "com.denuoweb.hnsdane.net.action.SYNC_SNAPSHOT"
        const val EXTRA_STATUS_JSON = "com.denuoweb.hnsdane.net.extra.STATUS_JSON"
        const val EXTRA_UPDATED_AT_MILLIS = "com.denuoweb.hnsdane.net.extra.UPDATED_AT_MILLIS"

        private const val ACTION_START = "com.denuoweb.hnsdane.net.action.START_SYNC"
        private const val ACTION_STOP = "com.denuoweb.hnsdane.net.action.STOP_SYNC"
