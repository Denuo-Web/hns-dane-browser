...
- The exact signed `0.3.15` APK passed a cache-cleared Pixel 9 acceptance test against `https://denuoweb/`: the proof-bootstrapped authoritative DoH endpoint completed all six DNS exchanges, UDP/TCP port 53 and compatibility DoH were not attempted, DNSSEC was secure, and DANE verified.
