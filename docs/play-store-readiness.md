...
PLAY_TRACK=alpha \
  ...
  dist/play-store/hns-dane-browser-v0.3.10-play-upload-signed.aab
```
...
1. Build and verify `dist/play-store/hns-dane-browser-v0.3.10-play-upload-signed.aab`.
