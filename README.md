...
- Decodes HSD name resource values into DNS-style DS, NS, in-zone glue A/AAAA, synthetic glue A/AAAA, TXT records, and experimental `hnsdns=1` RFC 8484 authoritative DoH transport declarations.
